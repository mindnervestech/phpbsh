	...
	App.controller('datatableCtrl', function ($scope, $http) {
		...
		var nrecoPivotExt = new NRecoPivotTableExtensions({
			drillDownHandler: function(dataFiler) {
				...
				$http({method:'post',url:'/api/report/reports/drildownreport',data:{searchCriteria:lastQueryCriteria,filters:dataFiler}}).success(function(data) {
					console.log(data);
		...
		$scope.loadReportsMd = function () {
			$http.get('/api/report/reports/md').success(function(resp){
				console.log(resp);
		...
		$scope.runReport = function (option) {
			...
			$http.get('/api/report/run',{params:{filter:obj}}).success(function(data){
				console.log(data);
				//$scope.finishedHeader = false;
